...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="text" id="email_{{ $user->id }}" name="email" class="form-control" value="{{ $emailUsername }}" required>
        <div class="input-group-append">
            <span class="input-group-text">@zear.com</span> <!-- or use dynamic domain here -->
        </div>
    </div>
</div>
