...
<div class="form-group">
    ...
    <textarea id="function" name="function" class="form-control" rows="3" style="resize: none;" required></textarea>
</div>
...
<div class="form-group">
    ...
    <textarea id="edit_function" name="function" class="form-control" rows="3" style="resize: none;" required></textarea>
</div>
