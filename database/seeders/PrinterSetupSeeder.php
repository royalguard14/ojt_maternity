...
class PrinterSetupSeeder extends Seeder
{
    public function run()
    {
        $printerSetting = [
            ...
            "m_occupation" => ["left" => "404.41px", "top" => "468.66px", "width" => "207.87px"],
            "m_ageBorn" => ["left" => "661.42px", "top" => "468.66px", "width" => "105.83px"],
            "m_res_brgy" => ["left" => "151.18px", "top" => "498.90px", "width" => "215.43px"],
            "m_res_city" => ["left" => "366.61px", "top" => "498.90px", "width" => "113.39px"],
            "m_res_province" => ["left" => "487.56px", "top" => "498.90px", "width" => "139.84px"],
            "m_res_country" => ["left" => "257.01px", "top" => "498.90px", "width" => "132.28px"],
            ...
            "f_citizenship" => ["left" => "113.39px", "top" => "578.27px", "width" => "132.28px"],
            "f_religion" => ["left" => "283.46px", "top" => "578.27px", "width" => "170.08px"],
            "f_occupation" => ["left" => "480.00px", "top" => "578.27px", "width" => "162.52px"],
            "f_ageBorn" => ["left" => "661.42px", "top" => "578.27px", "width" => "102.05px"],
            "f_res_brgy" => ["left" => "151.18px", "top" => "631.18px", "width" => "215.43px"],
            "f_res_city" => ["left" => "366.61px", "top" => "631.18px", "width" => "113.39px"],
            "f_res_province" => ["left" => "487.56px", "top" => "631.18px", "width" => "139.84px"],
            "f_res_country" => ["left" => "257.01px", "top" => "631.18px", "width" => "132.28px"],
            "mop_date_m" => ["left" => "132.28px", "top" => "691.65px", "width" => "83.15px"],
            "mop_date_d" => ["left" => "211.65px", "top" => "691.65px", "width" => "45.35px"],
            ...
            "coaab_name" => ["left" => "151.18px", "top" => "823.94px", "width" => "245.67px"],
            "coaab_position" => ["left" => "170.08px", "top" => "846.61px", "width" => "226.77px"],
            "coaab_address" => ["left" => "472.44px", "top" => "797.48px", "width" => "291.02px"],
            "coaab_date" => ["left" => "453.54px", "top" => "846.61px", "width" => "302.36px"],
            "coaab_time" => ["left" => "480.00px", "top" => "721.89px", "width" => "68.03px"],
            "coi_name" => ["left" => "151.18px", "top" => "937.32px", "width" => "245.67px"],
            "coi_relationship" => ["left" => "196.54px", "top" => "960.00px", "width" => "200.31px"],
            "coi_address_brgy" => ["left" => "132.28px", "top" => "982.68px", "width" => "272.13px"],
            "coi_date" => ["left" => "132.28px", "top" => "1005.35px", "width" => "264.57px"],
            "prepby_name" => ["left" => "510.24px", "top" => "944.88px", "width" => "245.67px"],
            "prepby_title" => ["left" => "517.80px", "top" => "967.56px", "width" => "238.11px"],
            "prepby_date" => ["left" => "472.44px", "top" => "1009.13px", "width" => "283.46px"]
        ];
